...
This can be done via **Settings → Team**, then **+ Team Member** (`Workspace Settings -> Team Members -> Invite Member` if your workspace hasn't moved to the new Settings experience yet).

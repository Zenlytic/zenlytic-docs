...
![Add to memory in chat](../.gitbook/assets/adding_to_memory.png)
...
![Create a new memory](../.gitbook/assets/creating_memory.png)

* **Text memory**: Enter the User question and Zoë response to specify how Zoë should answer similar questions.

![Create a text memory](../.gitbook/assets/creating_text_memory.png)

---
description: >-
  Connect Zoë to Atlan's MCP server to search data assets, glossaries, and
  lineage from chat.
---
...
3. Add the required header (see [Configure request headers](atlan.md#configure-request-headers)).

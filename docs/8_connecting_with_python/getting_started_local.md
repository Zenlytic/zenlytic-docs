...
To avoid working in local Python, use Context Manager in the Zenlytic UI for the same tasks listed below. Context Manager includes built-in validation and error tracking so you can catch issues as you edit.

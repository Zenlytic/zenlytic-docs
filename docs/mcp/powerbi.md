---
description: >-
  Connect Zoë to a Power BI MCP server to explore workspaces, datasets, and
  reports from chat.
---
...
3. Add the `Authorization` header (see [Configure request headers](powerbi.md#configure-request-headers)).

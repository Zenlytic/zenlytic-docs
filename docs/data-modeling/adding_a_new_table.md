...
![add-new-table-context-manager](../.gitbook/assets/add-new-table-data-model-editor.png)
...
![add-new-table-modal](../.gitbook/assets/add-new-table-modal.png)
...
![add-new-table-file-upload](../.gitbook/assets/add-new-table-file-upload.png)

---
description: >-
  Connect Zoë to Tableau's MCP server to browse workbooks, data sources, and
  metadata from chat.
---
...
3. Add credentials (see [Configure request headers](tableau.md#configure-request-headers)).

...
Cursor supports both native OAuth and static tokens for remote MCP servers, configured in an `mcp.json` file. See [MCP Server](./) for what you get once connected and general prerequisites.

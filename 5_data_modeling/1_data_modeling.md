...
* [Models](../5_data_modeling/2_model.md)
...
* [Views](../5_data_modeling/5_view.md)
    * Views directly represent a underlying database table. They contain both the [dimensions (columns)](../5_data_modeling/91_dimension.md) and [measures (aggregates)](../5_data_modeling/93_measure.md) inside of the table they reference. In addition, they contain [identifiers](../5_data_modeling/5_view.md#identifiers) which define the possible join to or from the table.

* [Dimensions](../5_data_modeling/91_dimension.md)
...
* [Measures (metrics)](../5_data_modeling/93_measure.md)

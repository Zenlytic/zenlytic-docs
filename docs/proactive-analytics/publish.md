---
description: >-
  Publish proactive agents so teammates can discover, run, and re-use approved
  workflows.
---

# Publish

By default, Proactive Agents are private to you, however, you can allow others in our organization to run and extend Proactive Agents when they are ready. The following image shows the _Publish_ popover that appears after clicking "Private"/"Shared" in the Proactive Agent Builder Header.
...
<figure><img src="../.gitbook/assets/agents/7-publish-proactive.png" alt=""><figcaption></figcaption></figure>

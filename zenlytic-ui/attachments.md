...
<figure><img src="../.gitbook/assets/attachments-dropdown.png" alt=""><figcaption><p>The attachments dropdown in the chat input</p></figcaption></figure>
...
{% hint style="info" %}
**CSV attachments in chat don't persist to your data model.** Files uploaded in a chat conversation go to Zoë's code interpreter only — they don't create views or fields that Zoë can query later. For persistent data, upload the file through the [Data Model Editor](data_model_editor.md) instead; that creates a proper view that Zoë can reference from any question.
{% endhint %}
...
<figure><img src="../.gitbook/assets/attachments-csv-response.png" alt=""><figcaption><p>Zoë analyzing an attached CSV with charts and narrative insights</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/attachments-query.png" alt=""><figcaption><p>Selecting metrics and slices for a query attachment</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/attachments-query-response.png" alt=""><figcaption><p>Zoë generating a visualization from attached query results</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/attachments-query-citations.png" alt=""><figcaption><p>Inline citations linking narrative text back to query results</p></figcaption></figure>

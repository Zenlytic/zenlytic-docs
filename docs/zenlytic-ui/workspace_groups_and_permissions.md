...
To create a group for sharing permissions, click on your account icon in the top right hand corner (green circle), and select **Settings**. Navigate to the **Team** section. Select the **Groups** tab.

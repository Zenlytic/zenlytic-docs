---
description: >-
  Build reusable Zoë conversations, run them on demand, and share
...
<figure><img src="../.gitbook/assets/agents/1-proactive-nav.png" alt=""><figcaption></figcaption></figure>
...
Proactive Agents allow us to define a specific Zoë task that will be run as a conversation. Let's click through the form options on this _New Proactive Agent_ page to get started. Click on the _Create Agent_ then the _Test Run_ button in the upper right-hand section to preview a run of our new Proactive Agent.
...
![message-done](../.gitbook/assets/agents/5-message-done.png)
...
<figure><img src="../.gitbook/assets/agents/6-save-as-proactive.png" alt=""><figcaption></figcaption></figure>

...
To integrate Zenlytic's data model with your dbt models, define the dimensions and measures (metrics) in semantic models section of dbt. Follow this page to get started with [Metricflow (dbt Semantic Layer)](https://docs.getdbt.com../build/sl-getting-started).
...
2. The usage of [natural keys](https://docs.getdbt.com../build/entities) in joins (using an array of fields to join instead of 1 field or custom SQL)
3. [Cumulative metrics](https://docs.getdbt.com../build/cumulative)
4. [Conversion metrics](https://docs.getdbt.com../build/conversion)
5. `offset_window` property in derived metrics
6. `Metric` and `Entity` parameterized [filter types](https://docs.getdbt.com../build/metrics-overview#filters)
